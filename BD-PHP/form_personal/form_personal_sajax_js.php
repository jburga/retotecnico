  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_personal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_personal_validate_num_documento()
  {
    var nomeCampo_num_documento = "num_documento";
    var var_num_documento = scAjaxGetFieldText(nomeCampo_num_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_personal_validate_num_documento(var_num_documento, var_script_case_init, do_ajax_form_personal_validate_num_documento_cb);
  } // do_ajax_form_personal_validate_num_documento

  function do_ajax_form_personal_validate_num_documento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_personal_validate_num_documento_cb

  // ---------- Validate nombre
  function do_ajax_form_personal_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_personal_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_personal_validate_nombre_cb);
  } // do_ajax_form_personal_validate_nombre

  function do_ajax_form_personal_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_personal_validate_nombre_cb

  // ---------- Validate apellido
  function do_ajax_form_personal_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_personal_validate_apellido(var_apellido, var_script_case_init, do_ajax_form_personal_validate_apellido_cb);
  } // do_ajax_form_personal_validate_apellido

  function do_ajax_form_personal_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_personal_validate_apellido_cb

  // ---------- Validate edad
  function do_ajax_form_personal_validate_edad()
  {
    var nomeCampo_edad = "edad";
    var var_edad = scAjaxGetFieldText(nomeCampo_edad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_personal_validate_edad(var_edad, var_script_case_init, do_ajax_form_personal_validate_edad_cb);
  } // do_ajax_form_personal_validate_edad

  function do_ajax_form_personal_validate_edad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "edad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_personal_validate_edad_cb
  // ---------- Form
  function do_ajax_form_personal_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_personal_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_personal_submit_form(var_num_documento, var_nombre, var_apellido, var_edad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_personal_submit_form_cb);
  } // do_ajax_form_personal_submit_form

  function do_ajax_form_personal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_personal_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_personal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_personal_navigate_form(var_num_documento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_personal_navigate_form_cb);
  } // do_ajax_form_personal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_personal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_personal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_personal_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_personal_navigate_form_cb
  function sc_hide_form_personal_form()
  {
