<?php  
  ...
  session_start() ;
  class form_personal_form_teste
  {
   function form_personal_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_personal/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_personal</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_personal"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_personal_form_teste();
  $frm_teste->form_personal_teste();
?>
